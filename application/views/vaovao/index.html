    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="assets/images/i99314-.webp" class="box-img" alt="" width="250px" height="300px">
            </div>
            <div class="detail-box">
              <h4>
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="assets/images/salade.avif" class="box-img" alt="" width="150px" height="250px">
            </div>
            <div class="detail-box">
              <h4>
                Réduire votre poids
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="assets/images/imc_ideal.jpg" class="box-img" alt="" width="250px" height="300px">
            </div>
            <div class="detail-box">
              <h4>
          ...
          <div class="col-md-7 col-lg-8">
            <div class="detail-box">
              ...
              <div class="app_btn_box">
                <a href="" class="mr-1">
                  <img src="assets/images/google_play.png" class="box-img" alt="">
                </a>
                <a href="">
                  <img src="assets/images/app_store.png" class="box-img" alt="">
                </a>
              </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box">
            <div class="img-box">
              <img src="assets/images/depositphotos_150452330-stock-photo-healthy-dinner-with-quinoa-chicken.jpg" class="box-img" alt="" height="362px">
            </div>
            <div class="detail-box">
              <h4>
                Plat équilibré
        ...
        <div class="col-md-6">
          <div class="box">
            <div class="img-box">
              <img src="assets/images/fafa4b665d_114351_smoothies-fruits-legumes-sante.jpg" class="box-img" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Smoothie légume
